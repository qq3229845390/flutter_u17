...
Widget buildView(BoutiqueState state, Dispatch dispatch, ViewService viewService) {
  ...
  Widget _buildCell(index) {
    SubscribeEntity entity = state.boutiques[index];
    ...
    return Container(
      ...
      child: Column(
        children: [
          _buildHead(entity),
          Container(
            height: (entity.comics.length/3).ceil() * ScreenUtil().setWidth(203),
            color: Colors.white,
